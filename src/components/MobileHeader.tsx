...
const MobileHeader: React.FC = () => {
    ...
    return (
        <div className="fixed top-0 inset-x-0 z-[6000] pointer-events-none">
            ...
            <div className="relative pt-6 px-6 flex justify-between items-start pointer-events-auto">
                <button className="text-white/60 hover:text-white transition-opacity active:scale-95 z-50 mt-1">
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 flex justify-center">
                    <div className="bg-black/90 backdrop-blur-3xl px-12 pb-5 pt-1 rounded-b-[45px] border-b border-x border-white/10 shadow-[0_25px_40px_rgba(0,0,0,0.9)] relative">
